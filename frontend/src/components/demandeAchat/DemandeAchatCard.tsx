...
/**
 * Carte DA/FAD à 2 lignes (numéro/objet/badge puis montant/procédure/
 * fournisseur), extraite de pages/Home.tsx le 15/09/2026 (écran de suivi RC)
 * pour être partagée avec pages/SuiviRc.tsx — même contenu/alignement dans
 * les deux écrans, seules les actions par ligne diffèrent.
 */
export function DemandeAchatCard({ demandeAchat: da, fournisseurLabel, actions }: DemandeAchatCardProps) {
  return (
    <article className="gp-panel accueil-da-card">
      <div className="row" style={{ justifyContent: 'space-between', alignItems: 'baseline', gap: 12, flexWrap: 'nowrap' }}>
      ...
      <div className="row" style={{ justifyContent: 'space-between', alignItems: 'center', gap: 12, marginTop: 6, flexWrap: 'nowrap' }}>
